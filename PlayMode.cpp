...
PlayMode::PlayMode() : scene(*phonebank_scene) {
	...
	for (auto& mesh : meshes) {
		if (mesh.first.find(str) != std::string::npos)// != std::string::npos && mesh.first.find("Cube.002") == std::string::npos && mesh.first.find("Cube.004") == std::string::npos && mesh.first.find("Cube.001") == std::string::npos)
		{
